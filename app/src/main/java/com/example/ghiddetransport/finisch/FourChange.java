...
public class FourChange extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_four_change);
    ...
    public void goNext(View v) {
        ...
        if(clickedButton == myButton2) {
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent intent = new Intent(FourChange.this, FiveChange.class);
